...
- **Five sync reference points — always return here when lost:**
  ...
  - `a1d80a4` (`baseline-sync-jul14`) — honest-signal era: refMs reconstruction sign fixed, cascade corrects only true divergence. Current production ceiling.
