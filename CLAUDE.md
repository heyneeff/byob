...
- **Four sync reference points — always return here when lost:**
  ...
  - `1016005` (`baseline-sync-jul6`) — anchor broadcast era: DJ live position as ground truth, launch guard, auto-resync. Current production ceiling.
